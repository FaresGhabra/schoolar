...
class LayoutService {
  ...
  public static initLayoutSettings(): void {
    ...
    if (layout === 'light-sidebar') {
      this.configStore.setLayoutConfigProperty('header.default.fixed.desktop', false);

      this.configStore.setLayoutConfigProperty('header.default.fixed.mobile', false);
    }

    if (layout === 'light-sidebar' || layout === 'dark-sidebar') {
      if (pageWidth === 'default') {
        this.configStore.setLayoutConfigProperty('header.default.container', 'fluid');
    ...
    if (layout === 'light-header' || layout === 'dark-header') {
      ...
      if (pageWidth === 'default') {
        this.configStore.setLayoutConfigProperty('header.default.container', 'fixed');
  ...
  public static initToolbarSettings(): void {
    const defaultContent = objectPath.get(config.value, 'header.default.content');
  ...
  public static initWidthSettings(): void {
    ...
    if (pageWidth !== 'default') {
      ...
      // Set page width
      this.configStore.setLayoutConfigProperty('header.default.container', container);
  ...
  public static initSidebar(): void {
    ...
    if (objectPath.get(config.value, 'sidebar.default.minimize.desktop.default')) {
      this.bodyStore.addBodyAttribute({
    ...
    if (objectPath.get(config.value, 'sidebar.primary.minimize.desktop.enabled')) {
      ...
      if (objectPath.get(config.value, 'sidebar.primary.minimize.desktop.hoverable')) {
        this.bodyStore.addBodyAttribute({
      ...
      if (objectPath.get(config.value, 'sidebar.primary.minimize.mobile.enabled')) {
        ...
        if (objectPath.get(config.value, 'sidebar.primary.minimize.mobile.hoverable')) {
          this.bodyStore.addBodyAttribute({
      ...
      if (objectPath.get(config.value, 'sidebar.primary.collapse.desktop.enabled')) {
        if (objectPath.get(config.value, 'sidebar.primary.collapse.desktop.default')) {
          this.bodyStore.addBodyAttribute({
      ...
      if (objectPath.get(config.value, 'sidebar.primary.collapse.mobile.enabled')) {
        if (objectPath.get(config.value, 'sidebar.primary.collapse.mobile.default')) {
          this.bodyStore.addBodyAttribute({
