    ...
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <router-link to="/apps/subscriptions/add-subscription" class="btn btn-primary">
        ...
        <div v-else class="d-flex justify-content-end align-items-center">
          ...
          <button type="button" class="btn btn-danger" @click="deleteFewSubscriptions()">Delete Selected</button>
        </div>
        <!--end::Group actions-->
      </div>
      <!--end::Card toolbar-->
