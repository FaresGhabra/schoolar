  ...
  <div class="card">
    ...
    <div class="card-body p-0">
      ...
      <div class="card-px text-center py-20 my-10">
        ...
        <!--begin::Action-->
        <router-link to="/apps/subscriptions/add-subscription" class="btn btn-primary">Add Subscription</router-link>
        <!--end::Action-->
      </div>
      <!--end::Wrapper-->
      ...
      <div class="text-center px-4">
        <img class="mw-100 mh-300px" alt="" :src="getIllustrationsPath('5.png')" />
      </div>
      <!--end::Illustration-->
    </div>
    <!--end::Card body-->
