              ...
              <div class="d-flex flex-stack py-4">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="symbol symbol-45px symbol-circle">
                    ...
                    <span v-else :class="`bg-light-${item.color} text-${item.color}`" class="symbol-label fs-6 fw-bold">
                      {{ item.name.charAt(0) }}
                    </span>
                    <div
                      v-if="item.online"
          ...
          <div class="card-title">
            ...
            <div class="d-flex justify-content-center flex-column me-3">
              <div v-if="isGroupChat" class="symbol-group symbol-hover">
                ...
                <div class="symbol symbol-35px symbol-circle">
                  <img alt="Pic" :src="getAssetPath('media/avatars/300-25.jpg')" />
                </div>
                <div class="symbol symbol-35px symbol-circle">
                  <span class="symbol-label bg-light-warning text-warning 40px">M</span>
                </div>
                <div class="symbol symbol-35px symbol-circle">
                  <img alt="Pic" :src="getAssetPath('media/avatars/300-9.jpg')" />
                </div>
                <div class="symbol symbol-35px symbol-circle">
                ...
                <div class="symbol symbol-35px symbol-circle">
                  <img alt="Pic" :src="getAssetPath('media/avatars/300-23.jpg')" />
                </div>
                <a
                  href="#"
