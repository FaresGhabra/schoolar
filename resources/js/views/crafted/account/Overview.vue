  ...
  <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-body p-9">
      ...
      <div class="row mb-7">
        ...
        <!--begin::Col-->
        <div class="col-lg-8">
          <a href="#" class="fw-semobold fs-6 text-dark text-hover-primary">keenthemes.com</a>
        </div>
        <!--end::Col-->
      </div>
      <!--end::Input group-->
      ...
      <div class="row mb-7">
        ...
        <label class="col-lg-4 fw-semobold text-muted">
          Country
          <i class="fas fa-exclamation-circle ms-1 fs-7" v-tooltip title="Country of origination"></i>
        </label>
        <!--end::Label-->
