<template>
  ...
  >
          ...
          <div class="stepper-item current" data-kt-stepper-element="nav">
            <div class="stepper-wrapper">
              ...
              <div class="stepper-label">
                ...
                <div class="stepper-desc fw-semobold">Setup Your Account Details</div>
              </div>
              <!--end::Label-->
            </div>
          ...
          <div class="stepper-item" data-kt-stepper-element="nav">
            <div class="stepper-wrapper">
              ...
              <div class="stepper-label">
                ...
                <div class="stepper-desc fw-semobold">Setup Your Account Settings</div>
              </div>
              <!--end::Label-->
            </div>
            <!--begin::Line-->
          ...
          <div class="stepper-item" data-kt-stepper-element="nav">
            <div class="stepper-wrapper">
              ...
              <div class="stepper-label">
                ...
                <div class="stepper-desc fw-semobold">Your Business Related Info</div>
              </div>
              <!--end::Label-->
            </div>
          ...
          <div class="stepper-item" data-kt-stepper-element="nav">
            <div class="stepper-wrapper">
              ...
              <div class="stepper-label">
                ...
                <div class="stepper-desc fw-semobold">Set Your Payment Methods</div>
              </div>
              <!--end::Label-->
            </div>
    ...
    <div class="card d-flex flex-row-fluid flex-center">
      <!--begin::Form-->
      <form class="py-20 w-100 w-xl-700px px-9" novalidate id="kt_create_account_form" @submit="handleStep">
        <!--begin::Step 1-->
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      _stepperObj.value = StepperComponent.createInsance(verticalWizardRef.value as HTMLElement);
    });
