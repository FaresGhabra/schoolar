    ...
    <div class="d-flex flex-column flex-lg-row-auto w-lg-350px w-xl-500px">
      ...
      >
        ...
        <div class="d-flex flex-center py-10 py-lg-20 mt-lg-20">
          <!--begin::Logo-->
          <router-link to="/">
            <img alt="Logo" :src="getAssetPath('media/logos/custom-1.png')" class="h-70px" />
          </router-link>
          <!--end::Logo-->
        </div>
        <!--end::Header-->
    ...
    <div class="d-flex flex-column flex-lg-row-fluid py-10">
      ...
      <div class="d-flex flex-center flex-column flex-column-fluid">
        ...
        <div class="w-lg-700px p-10 p-lg-15 mx-auto">
          <!--begin::Form-->
          <form class="my-auto pb-5" novalidate id="kt_create_account_form" @submit="handleStep">
            <!--begin::Step 1-->
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      _stepperObj.value = StepperComponent.createInsance(wizardRef.value as HTMLElement);
