  ...
  <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    >
      ...
      <div id="#kt_app_sidebar_menu" class="menu menu-column menu-rounded menu-sub-indention px-3" data-kt-menu="true">
        ...
        <div class="menu-item">
          <!--begin:Menu link-->
          <a class="menu-link" href="https://preview.keenthemes.com/metronic8/vue/docs/#/utilities">
            <span class="menu-icon">
              <i v-if="sidebarMenuIcons === 'bootstrap'" class="bi bi-briefcase fs-3"></i>
              <KTIcon v-else-if="sidebarMenuIcons === 'keenthemes'" icon-name="rocket" icon-class="fs-2" />
            </span>
        ...
        <div class="menu-item">
          <!--begin:Menu link-->
          <a class="menu-link" href="https://preview.keenthemes.com/metronic8/vue/docs/#/doc-overview">
            <span class="menu-icon">
              <i v-if="sidebarMenuIcons === 'bootstrap'" class="bi bi-box fs-3"></i>
              <KTIcon v-else-if="sidebarMenuIcons === 'keenthemes'" icon-name="abstract-26" icon-class="fs-2" />
            </span>
        ...
        <div class="menu-item">
          <!--begin:Menu link-->
          <a class="menu-link" href="https://preview.keenthemes.com/metronic8/vue/docs/#/changelog">
            <span class="menu-icon">
              <i v-if="sidebarMenuIcons === 'bootstrap'" class="bi bi-diagram-3 fs-3"></i>
              <KTIcon v-else-if="sidebarMenuIcons === 'keenthemes'" icon-name="code" icon-class="fs-2" />
            </span>
