<template>
  ...
  >
    <KTIcon icon-name="setting-4" icon-class="fs-4 me-1" />
    Customize
  </button>
                ...
                <div class="d-flex flex-stack gap-3">
                  ...
                  >
                    ...
                    <div class="form-check-wrapper d-flex flex-center border-gray-200 border-2 mb-0 py-3 px-4">
                      ...
                      />
                      <span class="fs-7 fw-semibold ms-2 text-gray-500 parent-active-gray-700 parent-hover-gray-700">
                        Duotone
                      </span>
                    </div>
                    <!--end::Image-->
              ...
              <div class="form-group">
                ...
                <div class="d-flex">
                  ...
                  <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5">
                    ...
                    />
                    <!--begin::Label-->
                    <label class="form-check-label text-gray-700 fw-bold text-nowrap" for="kt_builder_keenthemes_icons">
                      Keenthemes Icons
                    </label>
                    <!--end::Label-->
                  </div>
                  ...
                  <div class="form-check form-check-custom form-check-success form-check-solid form-check-sm me-5">
                    ...
                    />
                    <!--begin::Label-->
                    <label class="form-check-label text-gray-700 fw-bold text-nowrap" for="kt_builder_bootstrap_icons">
                      Bootstrap Icons
                    </label>
                    <!--end::Label-->
                  </div>
