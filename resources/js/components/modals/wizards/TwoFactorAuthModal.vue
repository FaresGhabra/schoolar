        ...
        <div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
          ...
          <div :class="[state !== '' && 'd-none']">
            ...
            <p class="text-gray-400 fs-5 fw-semobold mb-10">
              In addition to your username and password, you’ll have to enter a code (delivered via app or SMS) to log
              into your account.
            </p>
            <!--end::Notice-->
            ...
            <!--begin::Action-->
            <button @click="state = value" class="btn btn-primary w-100">Continue</button>
            <!--end::Action-->
          </div>
          <!--end::Options-->
          ...
          <div :class="[state !== 'apps' && 'd-none']" data-kt-element="apps">
            ...
            <div class="text-gray-500 fw-semobold fs-6 mb-10">
              ...
              <div class="pt-5 text-center">
                <img :src="getAssetPath('media/misc/qr.png')" alt="" class="mw-150px" />
              </div>
              <!--end::QR code image-->
            </div>
            <!--end::Description-->
            ...
            <div class="notice d-flex bg-light-warning rounded border-warning border border-dashed mb-10 p-6">
              <KTIcon icon-name="formation-5" icon-class="fs-2tx text-warning me-4" />
              <!--begin::Wrapper-->
              <div class="d-flex flex-stack flex-grow-1">
                <!--begin::Content-->
                <div class="fw-semobold">
                  <div class="fs-6 text-gray-600">
                    If you having trouble using the QR code, select manual entry on your app, and enter your username
                    and the code:
            ...
            <!--begin::Form-->
            <VForm class="form" @submit="submitAuthCodeForm()" :validation-schema="schema2">
              <!--begin::Input group-->
              ...
              <div class="d-flex flex-center">
                <button type="reset" @click="state = ''" class="btn btn-light me-3">Cancel</button>
          ...
          <div :class="[state !== 'sms' && 'd-none']" data-kt-element="sms">
            ...
            <!--begin::Form-->
            <VForm class="form" @submit="submitMobileForm()" :validation-schema="schema1">
              <!--begin::Input group-->
              <div class="mb-10 fv-row">
                <Field
                  type="text"
              ...
              <!--begin::Actions-->
              <div class="d-flex flex-center">
                <button @click="state = ''" class="btn btn-light me-3">Cancel</button>

                <button ref="submitMobileButtonRef" type="submit" data-kt-element="sms-submit" class="btn btn-primary">
                  <span class="indicator-label">Submit</span>
                  <span class="indicator-progress">
                    Please wait...
                    <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
