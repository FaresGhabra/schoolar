<template>
  ...
  <div class="modal fade" id="kt_modal_create_account" ref="createAccountModalRef" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1000px">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y m-5">
          <!--begin::Stepper-->
          <div ref="createAccountRef" class="stepper stepper-links d-flex flex-column" id="kt_create_account_stepper">
            <!--begin::Nav-->
            ...
            <!--begin::Form-->
            <form class="mx-auto mw-600px w-100 py-10" novalidate id="kt_create_account_form" @submit="handleStep">
              <!--begin::Step 1-->
                      ...
                      <div class="col-lg-6">
                        ...
                        >
                          ...
                          <span class="d-block fw-semobold text-start">
                            ...
                            <span class="text-gray-400 fw-semobold fs-6">Create corporate account to mane users</span>
                          </span>
                          <!--end::Info-->
                        </label>
                        <!--end::Option-->
                ...
                <div class="w-100">
                  ...
                  <div class="mb-10 fv-row">
                    ...
                    <Field
                      ...
                      value=""
                    />
                    <ErrorMessage class="fv-plugins-message-container invalid-feedback" name="teamAccountName" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                    ...
                    <div class="mb-0">
                      ...
                      <label class="d-flex flex-stack mb-5 cursor-pointer">
                        ...
                        <span class="d-flex align-items-center me-2">
                          ...
                          <span class="d-flex flex-column">
                            ...
                            <span class="fs-6 fw-semobold text-gray-400">Use images to enhance your post flow</span>
                          </span>
                          <!--end:Description-->
                        </span>
                        <!--end:Label-->
                      ...
                      <label class="d-flex flex-stack mb-5 cursor-pointer">
                        ...
                        <span class="d-flex align-items-center me-2">
                          ...
                          <span class="d-flex flex-column">
                            ...
                            <span class="fs-6 fw-semobold text-gray-400">Use images to your post time</span>
                          </span>
                          <!--end:Description-->
                        </span>
                        <!--end:Label-->
                      ...
                      <label class="d-flex flex-stack mb-0 cursor-pointer">
                        ...
                        <span class="d-flex align-items-center me-2">
                          ...
                          <span class="symbol symbol-50px me-6">
                            <span class="symbol-label">
                              <KTIcon icon-name="chart-pie-4" icon-class="fs-1 text-gray-600" />
                            </span>
                          </span>
                          <!--end::Icon-->
                          ...
                          <span class="d-flex flex-column">
                            ...
                            <span class="fs-6 fw-semobold text-gray-400">Use images to enhance time travel rivers</span>
                          </span>
                          <!--end:Description-->
                        </span>
                        <!--end:Label-->
              ...
              <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                  ...
                  <div class="fv-row mb-10">
                    ...
                    />
                    <ErrorMessage class="fv-plugins-message-container invalid-feedback" name="businessName" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                ...
                "
                    ...
                    <Field
                      ...
                      value="KEENTHEMES"
                    />
                    <ErrorMessage class="fv-plugins-message-container invalid-feedback" name="shortenedDescriptor" />
                    <!--end::Input-->
                  ...
                  <div class="fv-row mb-10">
                    ...
                    <!--begin::Input-->
                    <Field name="corporationType" class="form-select form-select-lg form-select-solid" as="select">
                      <option></option>
                      <option label="Corporation" value="1">Corporation</option>
                      <option label="Sole Proprietorship" value="2">Sole Proprietorship</option>
                      <option label="Non-profit" value="3">Non-profit</option>
                      <option label="Limited Liability" value="4">Limited Liability</option>
                      <option label="General Partnership" value="5">General Partnership</option>
                    </Field>
                  ...
                  <div class="fv-row mb-10">
                    ...
                    <Field
                      ...
                      rows="3"
                    />
                    <ErrorMessage class="fv-plugins-message-container invalid-feedback" name="businessDescription" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                  ...
                  <div class="fv-row mb-0">
                    ...
                    />
                    <ErrorMessage class="fv-plugins-message-container invalid-feedback" name="contactEmail" />
                    <!--end::Input-->
                  </div>
                  <!--end::Input group-->
                </div>
              ...
              <div data-kt-stepper-element="content">
                ...
                <div class="w-100">
                  ...
                  <div class="d-flex flex-column mb-7 fv-row">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semobold form-label mb-2">Card Number</label>
                    <!--end::Label-->
                    ...
                    <div class="position-relative">
                      ...
                      <div class="position-absolute translate-middle-y top-50 end-0 me-5">
                        ...
                        <img :src="getAssetPath('media/svg/card-logos/mastercard.svg')" alt="" class="h-25px" />
                        <img :src="getAssetPath('/media/svg/card-logos/american-express.svg')" alt="" class="h-25px" />
                      </div>
                      <!--end::Card logos-->
                    </div>
                    <!--end::Input wrapper-->
                  ...
                  <div class="row mb-10">
                    ...
                    <div class="col-md-8 fv-row">
                      <!--begin::Label-->
                      <label class="required fs-6 fw-semobold form-label mb-2">Expiration Date</label>
                      <!--end::Label-->
                  ...
                  <div class="d-flex flex-stack">
                    <!--begin::Label-->
                    <div class="me-5">
                      <label class="fs-6 fw-semobold form-label">Save Card for further billing?</label>
                    ...
                    <label class="form-check form-switch form-check-custom form-check-solid">
                      ...
                      <span class="form-check-label fw-semobold text-gray-400">Save Card</span>
                    </label>
                    <!--end::Switch-->
                  </div>
                  <!--end::Input group-->
                ...
                <div class="w-100">
                  ...
                  <div class="pb-8 pb-lg-10">
                    ...
                    <div class="text-gray-400 fw-semobold fs-6">
                      ...
                      <router-link to="/sign-in" class="link-primary fw-bold">Sign In</router-link>
                      .
                    </div>
                    <!--end::Notice-->
                  </div>
                  ...
                  <div class="mb-0">
                    ...
                    <div class="fs-6 text-gray-600 mb-5">
                      ...
                      own post, but for all advise is with what works for your great & amazing audience.
                    </div>
                    <!--end::Text-->
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      _stepperObj.value = StepperComponent.createInsance(createAccountRef.value as HTMLElement);
    });
    ...
    const createAppSchema = [
      ...
      Yup.object({
        ...
        shortenedDescriptor: Yup.string().required().label('Shortened descriptor'),
