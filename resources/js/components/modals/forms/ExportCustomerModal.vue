        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          <el-form @submit.prevent="submit()" :model="formData" :rules="rules" ref="formRef">
            ...
            <div class="fv-row mb-10">
              <!--begin::Label-->
              <label class="fs-5 fw-semobold form-label mb-5">Select Date Range:</label>
              <!--end::Label-->
            ...
            <div class="row fv-row mb-15">
              ...
              <div class="d-flex flex-column">
                <el-radio class="mb-5" v-model="formData.paymentType" label="All"></el-radio>
                <el-radio class="mb-5" v-model="formData.paymentType" label="Visa"></el-radio>
                <el-radio class="mb-5" v-model="formData.paymentType" label="Mastercard"></el-radio>
                <el-radio v-model="formData.paymentType" label="American Express"></el-radio>
              </div>
              <!--end::Input group-->
            </div>
            <!--end::Row-->
