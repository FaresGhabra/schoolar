            ...
            >
              ...
              <div id="kt_modal_add_customer_billing_info" class="collapse show">
                ...
                <div class="d-flex flex-column mb-7 fv-row">
                  <!--begin::Label-->
                  <label class="required fs-6 fw-semobold mb-2">Address Line 1</label>
                  <!--end::Label-->
                ...
                <div class="row g-9 mb-7">
                  ...
                  <div class="col-md-6 fv-row">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semobold mb-2">State / Province</label>
                    <!--end::Label-->
                  ...
                  <div class="col-md-6 fv-row">
                    <!--begin::Label-->
                    <label class="required fs-6 fw-semobold mb-2">Post Code</label>
                    <!--end::Label-->
                ...
                <div class="fv-row mb-7">
                  ...
                  <div class="d-flex flex-stack">
                    ...
                    <div class="me-5">
                      <!--begin::Label-->
                      <label class="fs-6 fw-semobold">Use as a billing adderess?</label>
                      <!--end::Label-->

                      <!--begin::Input-->
                      <div class="fs-7 fw-semobold text-muted">If you need more info, please check budget planning</div>
                      <!--end::Input-->
                    </div>
                    <!--end::Label-->
                    ...
                    <label class="form-check form-switch form-check-custom form-check-solid">
                      ...
                      <!--begin::Label-->
                      <span class="form-check-label fw-semobold text-muted" for="kt_modal_add_customer_billing">
                        Yes
                      </span>
                      <!--end::Label-->
                    </label>
