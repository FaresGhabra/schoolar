<template>
  ...
  <div class="modal fade" ref="newAddressModalRef" id="kt_modal_new_address" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
      ...
      <div class="modal-content">
        ...
        >
            ...
            >
              ...
              <div class="row mb-5">
                ...
                <div class="col-md-6 fv-row">
                  <!--begin::Label-->
                  <label class="required fs-5 fw-semobold mb-2">First name</label>
                  <!--end::Label-->
                ...
                <div class="col-md-6 fv-row">
                  <!--end::Label-->
                  <label class="required fs-5 fw-semobold mb-2">Last name</label>
                  <!--end::Label-->
              ...
              <div class="d-flex flex-column mb-5 fv-row">
                ...
                >
                  ...
                  <option v-for="(item, i) in countries" :key="`countries-select-option-${i}`" :value="item.code">
                    {{ item.name }}
                  </option>
                </Field>
              ...
              <div class="d-flex flex-column mb-5 fv-row">
                <!--begin::Label-->
                <label class="required fs-5 fw-semobold mb-2">Address Line 1</label>
                <!--end::Label-->
              ...
              <div class="d-flex flex-column mb-5 fv-row">
                <!--begin::Label-->
                <label class="required fs-5 fw-semobold mb-2">Address Line 2</label>
                <!--end::Label-->
              ...
              <div class="fv-row mb-5">
                ...
                <div class="d-flex flex-stack">
                  ...
                  <div class="me-5">
                    <!--begin::Label-->
                    <label class="fs-5 fw-semobold">Use as a billing adderess?</label>
                    <!--end::Label-->
                  ...
                  <label class="form-check form-switch form-check-custom form-check-solid">
                    ...
                    <!--begin::Label-->
                    <span class="form-check-label fw-semobold text-gray-400">Yes</span>
                    <!--end::Label-->
                  </label>
                  <!--end::Switch-->
                </div>
          ...
          <div class="modal-footer flex-center">
            ...
            <!--begin::Button-->
            <button ref="submitButtonRef" type="submit" id="kt_modal_new_address_submit" class="btn btn-primary">
