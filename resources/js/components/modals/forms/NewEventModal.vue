<template>
  <div class="modal fade show" id="kt_modal_add_event" aria-modal="true" role="dialog" ref="newTargetModalRef">
          ...
          <div class="modal-body py-10 px-lg-17">
            ...
            <div class="fv-row mb-9 fv-plugins-icon-container">
              ...
              <el-form-item prop="eventName">
                <el-input v-model="targetData.eventName" type="text" name="eventName" />
              </el-form-item>
              <!--end::Input-->
            ...
            <div class="fv-row mb-9">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <el-input v-model="targetData.eventDescription" type="text" placeholder="" name="eventDescription" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            <div class="fv-row mb-9">
              ...
              <!--end::Label-->
              <!--begin::Input-->
              <el-input v-model="targetData.eventLocation" type="text" placeholder="" name="eventLocation" />
              <!--end::Input-->
            </div>
            <!--end::Input group-->
            <!--begin::Input group-->
            ...
            <div class="row row-cols-lg-2 g-10">
              <div class="col">
                <div class="fv-row mb-9 fv-plugins-icon-container fv-plugins-bootstrap5-row-valid">
                  ...
                  <!--end::Label-->
                  <!--begin::Input-->
                  <el-date-picker v-model="targetData.eventEndDate" type="date" :teleported="false" name="eventName" />
                  <!--end::Input-->
                  <div class="fv-plugins-message-container invalid-feedback"></div>
                </div>
              </div>
