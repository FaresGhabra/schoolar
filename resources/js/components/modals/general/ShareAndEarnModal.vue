      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y pt-0 pb-15">
          ...
          <div class="mw-lg-600px mx-auto">
            ...
            <div class="mb-10">
              <!--begin::Title-->
              <h4 class="fs-5 fw-semobold text-gray-800">Share my referral link with friends</h4>
              <!--end::Title-->
            ...
            <div class="d-flex">
              <a href="#" class="btn btn-light-primary w-100">
                <img alt="Logo" :src="getAssetPath('media/svg/brand-logos/google-icon.svg')" class="h-15px me-3" />
                Import Contacts
              </a>

              <a href="#" class="btn btn-icon btn-facebook w-100 mx-6">
                <img alt="Logo" :src="getAssetPath('media/svg/brand-logos/facebook-2.svg')" class="h-20px me-3" />
                Facebook
              </a>

              <a href="#" class="btn btn-icon btn-twitter w-100">
                <img alt="Logo" :src="getAssetPath('media/svg/brand-logos/twitter.svg')" class="h-20px me-3" />
                Twitter
              </a>
            </div>
            <!--end::Actions-->
            ...
            <div class="d-flex align-items-center mt-10">
              ...
              <div class="flex-grow-1">
                <span class="fs-6 fw-semobold text-gray-800 d-block">Adding Users by Team Members</span>

                <span class="fs-7 fw-semobold text-gray-400">If you need more info, please check budget planning</span>
              </div>
              <!--end::Label-->
