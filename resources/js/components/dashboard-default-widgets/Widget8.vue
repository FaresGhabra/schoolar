              ...
              <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                ...
                <div class="d-flex align-items-center me-5 me-xl-13">
                  ...
                  <div class="symbol symbol-30px symbol-circle me-3">
                    <img :src="getAssetPath('media/avatars/300-3.jpg')" class="" alt="" />
                  </div>
                  <!--end::Symbol-->
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="symbol symbol-30px symbol-circle me-3">
                    <span class="symbol-label bg-success">
                      <KTIcon icon-name="abstract-41" icon-class="fs-5 text-white" />
                    </span>
                  </div>
                  <!--end::Symbol-->
              ...
              <div class="symbol-group symbol-hover flex-nowrap">
                <div class="symbol-group symbol-hover flex-nowrap">
                  <div class="symbol symbol-35px symbol-circle">
                    <img alt="Pic" :src="getAssetPath('media/avatars/300-2.jpg')" />
                  </div>
                  <div class="symbol symbol-35px symbol-circle">
                    <img alt="Pic" :src="getAssetPath('media/avatars/300-3.jpg')" />
                  </div>
                  <div class="symbol symbol-35px symbol-circle">
