...
export default defineComponent({
  ...
  setup(props, { expose }) {
    const initChart = () => {
      ...
      var options = {
        size: el.getAttribute('data-kt-size') ? parseInt(el.getAttribute('data-kt-size') as string) : 70,
        lineWidth: el.getAttribute('data-kt-line') ? parseInt(el.getAttribute('data-kt-line') as string) : 11,
        rotate: el.getAttribute('data-kt-rotate') ? parseInt(el.getAttribute('data-kt-rotate') as string) : 145,
      ...
      var drawCircle = function (color: string, lineWidth: number, percent: number) {
