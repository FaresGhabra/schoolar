    ...
    <div class="card-body pt-6">
      ...
      <div class="tab-content">
        ...
        <div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
          ...
          <!--begin::Chart-->
          <apexchart ref="chartRef1" type="bubble" :options="chart" :series="series1" :height="height"></apexchart>
          <!--end::Chart-->
        ...
        <div class="tab-pane fade active show" id="kt_chart_widget_8_month_tab" role="tabpanel">
          ...
          <!--begin::Chart-->
          <apexchart ref="chartRef2" type="bubble" :options="chart" :series="series2" :height="height"></apexchart>
          <!--end::Chart-->
