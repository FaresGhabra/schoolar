            ...
            <template v-for="(row, i) in table" :key="i">
              <tr>
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex justify-content-start flex-column">
                      <a href="#" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">{{ row.title }}</a>
                ...
                <td class="text-end pe-0">
                  <span class="text-gray-600 fw-bold fs-6">$ {{ row.price }}</span>
                </td>

                <td class="text-end pe-0">
                  <!--begin::Label-->
                  <span v-if="row.icon" class="badge badge-light-success fs-base">
                  ...
                  <span v-else class="badge badge-light-danger fs-base">
                    <KTIcon icon-name="arrow-down" icon-class="fs-5 text-danger ms-n1" />
                    {{ row.statistics }} %
                  </span>
                  <!--end::Label-->
                </td>
                ...
                <td class="text-end pe-12">
                  <span :class="`badge py-3 px-4 fs-7 badge-light-${row.status.state}`">{{ row.status.label }}</span>
                </td>
