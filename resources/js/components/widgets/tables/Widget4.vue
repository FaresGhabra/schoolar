    ...
    <div class="card-body py-3">
      <div class="tab-content">
        <template v-for="(item, index) in items" :key="index">
          <!--begin::Tap pane-->
          <div :class="[index === 0 && 'show active']" class="tab-pane fade" :id="`kt_table_widget_4_tab_${index + 1}`">
                  ...
                  <template v-for="(item1, index1) in item" :key="index1">
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="text-muted fw-semobold d-block fs-7">{{ item1.user.position }}</span>
                      </td>
                      <td>
                        ...
                        <div class="rating">
                          <template v-for="i in 5" :key="i">
                            <div :class="[item1.rating >= i && 'checked']" class="rating-label me-2">
