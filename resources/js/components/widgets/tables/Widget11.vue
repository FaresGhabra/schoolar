                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex justify-content-start flex-column">
                      ...
                      <span class="text-muted fw-semobold text-muted d-block fs-7">{{ item.product.specs }}</span>
                    </div>
                  </div>
                </td>

                <td>
                  <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ item.price }}</a>
                  <span class="text-muted fw-semobold text-muted d-block fs-7">Paid</span>
                </td>

                <td>
                  <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ item.deposit }}</a>
                  <span class="text-muted fw-semobold text-muted d-block fs-7">Rejected</span>
                </td>

                <td>
                  <a href="#" class="text-dark fw-bold text-hover-primary d-block mb-1 fs-6">{{ item.agent.name }}</a>
                  <span class="text-muted fw-semobold text-muted d-block fs-7">{{ item.agent.position }}</span>
                </td>
