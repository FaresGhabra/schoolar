                ...
                <tbody>
                  <template v-for="(item1, index1) in item" :key="index1">
                    <tr>
                      ...
                      <td>
                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ item1.info.title }}</a>
                        <span class="text-muted fw-semobold d-block fs-7">{{ item1.info.description }}</span>
                      </td>
                      <td class="text-end">
                      ...
                      <td class="text-end">
                        <span :class="`badge-light-${item1.badge.color}`" class="badge fs-7 fw-bold">
                          {{ item1.badge.label }}
                        </span>
                      </td>
                      <td class="text-end">
