    ...
    <div class="card-body py-3">
      <div class="tab-content">
        <template v-for="(item, index) in items" :key="index">
          <!--begin::Tap pane-->
          <div :class="[index === 0 && 'active show']" class="tab-pane fade" :id="`kt_table_widget_8_tab_${index + 1}`">
                      ...
                      <td>
                        <div class="symbol symbol-50px me-2">
                          <span :class="`bg-light-${item1.icon.color}`" class="symbol-label">
                            <KTIcon :icon-name="item1.icon.file" :icon-class="`text-${item1.icon.color} fs-2x`" />
                          </span>
                        </div>
                      </td>
                      <td>
                        <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ item1.info.event }}</a>
                        <span class="text-muted fw-semobold d-block fs-7">{{ item1.info.user }}</span>
                      </td>
                      <td class="text-end">
