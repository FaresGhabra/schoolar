          ...
          <tbody>
            <template v-for="(item, index) in items" :key="index">
              <tr>
                ...
                <td>
                  <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ item.info.title }}</a>
                ...
                <td class="text-end">
                  <template v-for="(item1, index1) in item.badges" :key="index1">
                    <span :class="`badge-light-${item1.color}`" class="badge fw-semobold me-1">{{ item1.label }}</span>
                  </template>
                </td>
                <td class="text-end">
...
import Dropdown1 from '../../dropdown/Dropdown1.vue';
