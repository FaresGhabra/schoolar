                ...
                <td>
                  <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex justify-content-start flex-column">
                      <a href="#" class="text-dark fw-bold text-hover-primary mb-1 fs-6">{{ item.user.name }}</a>

                      <a href="#" class="text-muted text-hover-primary fw-semobold text-muted d-block fs-7">
