  ...
  <div class="card card-flush pt-3 mb-5 mb-xl-10">
    ...
    <div class="card-header">
      ...
      <div class="card-toolbar">
        <router-link to="/subscriptions/add" class="btn btn-light-primary">Update Product</router-link>
      </div>
      <!--end::Card toolbar-->
    </div>
    <!--end::Card header-->
            ...
            <table class="table fs-6 fw-semobold gs-0 gy-2 gx-2 m-0">
              ...
              <tr>
                ...
                <td class="text-gray-800 min-w-200px">
                  <router-link to="/subscriptions/view" class="text-gray-800 text-hover-primary">
                    e.smith@kpmg.com.au
                  </router-link>
                </td>
              </tr>
