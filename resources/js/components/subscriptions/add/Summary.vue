    ...
    <div class="card-body pt-0 fs-6">
      ...
      <div class="mb-7">
        ...
        <div class="d-flex align-items-center mb-1">
          <!--begin::Name-->
          <router-link to="/apps/subscriptions/view-subscription" class="fw-bold text-gray-800 text-hover-primary me-2">
            Sean Bean
          </router-link>
          <!--end::Name-->
      ...
      <div class="mb-10">
        ...
        <div class="mb-0">
          ...
          <div class="fw-semobold text-gray-600 d-flex align-items-center">
            Mastercard
            <img :src="getAssetPath('media/svg/card-logos/mastercard.svg')" class="w-35px ms-2" alt="" />
          </div>
          <!--end::Card info-->
