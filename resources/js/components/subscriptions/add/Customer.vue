<template>
  ...
  <div class="card card-flush pt-3 mb-5 mb-lg-10">
    ...
    <div class="card-body pt-0">
      <!--begin::Description-->
      <div class="text-gray-500 fw-semobold fs-5 mb-5">Select or add a customer to a subscription:</div>
      <!--end::Description-->
      ...
      <div class="d-flex align-items-center p-3 mb-2">
        ...
        <div class="d-flex flex-column">
          ...
          <!--begin::Email-->
          <a href="#" class="fw-semobold text-gray-600 text-hover-primary">sean@dellito.com</a>
          <!--end::Email-->
        </div>
        <!--end::Info-->
      </div>
      ...
      <div class="mb-7 d-none">
        <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_customer_search">
          Select Customer
        </a>
      ...
      <div class="mb-10">
        <a href="#" class="btn btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_customer_search">
          Change Customer
        </a>
      </div>
