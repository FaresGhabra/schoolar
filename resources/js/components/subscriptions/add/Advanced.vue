    ...
    <div class="card-body pt-0">
      ...
      <div class="d-flex flex-column mb-15 fv-row">
        ...
        <div class="table-responsive">
          <!--begin::Table-->
          <table id="kt_create_new_custom_fields" class="table align-middle table-row-dashed fw-semobold fs-6 gy-5">
            <!--begin::Table head-->
            <thead>
        ...
        <button type="button" class="btn btn-light-primary me-auto" id="kt_create_new_custom_fields_add">
          Add custom field
        </button>
