  ...
  <div class="py-5">
    <div class="highlight">
      ...
      <ul class="nav nav-pills" role="tablist">
        ...
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="tab" :href="`#kt_highlight_${jsId}`" role="tab" aria-selected="false">
            JAVASCRIPT
          </a>
        </li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane fade active show" :id="`kt_highlight_${htmlId}`" role="tabpanel">
          <div class="highlight-code">
            <pre class="language-html"><code class="language-html"><slot name="html"></slot></code></pre>
          </div>
        </div>
        <div class="tab-pane fade" :id="`kt_highlight_${jsId}`" role="tabpanel">
          <div class="highlight-code">
            <pre class="language-js"><code class="language-js"><slot name="js"></slot></code></pre>
          </div>
        </div>
      </div>
    </div>
