  ...
  <div class="w-100">
    ...
    <div class="fv-row">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          ...
          >
            ...
            <span class="d-block fw-semobold text-start">
              ...
              <span class="text-gray-400 fw-semobold fs-6">If you need more info, please check it out</span>
            </span>
            <!--end::Info-->
          </label>
          <!--end::Option-->
        ...
        <ErrorMessage name="accountType" class="fv-plugins-message-container invalid-feedback"></ErrorMessage>
      </div>
      <!--end::Row-->
    </div>
    <!--end::Input group-->
